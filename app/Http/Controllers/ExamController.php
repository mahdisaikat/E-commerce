...
class ExamController extends Controller
{
    ...
    protected ExamsDataTable $dataTable;
    protected string $title;
    protected string $indexRoute;
    protected array $formFields;
    private $imageService;

    public function __construct(Exam $model, ExamsDataTable $dataTable)
    {
        $this->model = $model;
        $this->dataTable = $dataTable;
        $this->title = __('backend.exam');
        $this->indexRoute = 'exams';
    ...
    protected function initializeFormFields(): array
    {
        return [
            ...
            ['name' => 'exam_date', 'type' => 'date', 'label' => __('backend.exam_date')],
        ];
    }
    /**
