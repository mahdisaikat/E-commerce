...
class SchedulesDataTable extends DataTable {
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('title', fn($query) => $query->title ?? '-')
            ->editColumn('start_time', fn($query) => $query->start_time?->format('h:i a') ?? '-')
            ->editColumn('end_time', fn($query) => $query->end_time?->format('h:i a') ?? '-')
    ...
    public function getColumns(): array
    {
        $columns = [
            ...
            Column::make('start_time')->title(trans('backend.start_time')),
            Column::make('end_time')->title(trans('backend.end_time')),
            Column::make('description')->title(trans('backend.description')),
