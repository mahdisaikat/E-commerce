...
class SlidersDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('header', function ($query) {
                return $query->header ?? '-';
            })
    ...
    public function getColumns(): array
    {
        $columns = [
            ...
            // Column::make('link')->title(trans('backend.link')),
            Column::make('header')->title(trans('backend.header')),
            Column::make('details')->title(trans('backend.details')),
