...
class CategoriesDataTable extends DataTable
{
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('image', function ($query) {
                if ($query->images->isNotEmpty()) {
                    return '<img src="' . asset('storage/images/' . $query->images[0]->type . '/' . $query->images[0]->filename) . '" alt="' . $this->title . ' Image" style="width: 50px; height: 50px; object-fit: cover;">';
                }
                return '-';
            })
    ...
    {
        return $this->model->newQuery()->where('type', Category::TYPE_PRODUCT);
    }
    ...
    public function getColumns(): array
    {
        $columns = [
            ...
            Column::make('parent')->title(trans('backend.parent')),
